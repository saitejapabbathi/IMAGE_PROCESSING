...
#        file.close()
        ...
        img1 = Compare().meanSquareError(original, lsb_encoded_img)
        img2 = Compare().meanSquareError(original, dct_encoded_img)
        ...
        i1 = Compare().psnr(original, lsb_encoded_img)
        i2 = Compare().psnr(original, dct_encoded_img)
